...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-623-erd-s-problem-623-6a27d6ae-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-623"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-623-erd-s-problem-623-6a27d6ae-v1",
      "problem_contract_sha256": "65e5510c1f74ea92098f7d9e1894ae2fc4e5a25c040e7f0155d0485f15804691",
      "problem_id": "problem:um-ep-623-erd-s-problem-623-6a27d6ae",
      "route_id": "route:um-ep-623-erd-s-problem-623-6a27d6ae-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-623-erd-s-problem-623-6a27d6ae-source-fidelity-01",
      "graph_id": "graph:um-ep-623-erd-s-problem-623-6a27d6ae-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-623-erd-s-problem-623-6a27d6ae-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-623-erd-s-problem-623-6a27d6ae-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $X$ be a set of cardinality $\\aleph_\\omega$ and $f$ be a function from the finite subsets of $X$ to $X$ such that $f(A) ot\\in A$ for all $A$. Must there exist an infinite $Y\\subseteq X$ that is independent - that is, for all finite $B\\subset Y$ we have $f(B) ot\\in Y$?"
          },
          "statement_sha256": "a855eb13bb80287f68e295d2b95e9c9f064b2ba5c7d37ddc16b865253bfbbc89"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-623-erd-s-problem-623-6a27d6ae-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-623-erd-s-problem-623-6a27d6ae-root",
      "route_id": "route:um-ep-623-erd-s-problem-623-6a27d6ae-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-623-ced34e0e128b",
        "url": "https://www.unsolvedmath.com/problems/EP-623"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
